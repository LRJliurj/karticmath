...
batch_size = 5
running_count = 5000
jpgpath='D:\\opt\\data\\fire\\VOCdevkit\\my20181018\\Voc_Train_20181018\\JPEGImages\\'
xmlpath='D:\\opt\\data\\fire\\VOCdevkit\\my20181018\\Voc_Train_20181018\\Annotations\\'
file_name_list = os.listdir(jpgpath)
...
lable_arr = ['background','head','helmet','neg','fire_extinguisher','oxygen_tank','acetylene_bottle']
img_size = [300, 300]
# 分类总数量
classes_size = 7
# 背景分类的值
...
def get_traindata_voc(batch_size):
    ...
    for f_name in file_list:
        img_path = jpgpath + f_name
        xml_path = xmlpath + f_name.replace('.jpg', '.xml')
